...
Simplify term agreements in your React applications with [@cloudterms/react](https://www.npmjs.com/package/@cloudterms/react). This package provides a pre-built CloudTermsProvider component that wraps your app, ensuring users agree to terms before accessing your content.
...
- Includes the [@cloudterms/js](./js) SDK.
